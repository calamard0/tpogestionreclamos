	...
	public VistaReclamosPorMes() {
		...
		btnAceptar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				textFieldCantidadReclamos.setText(String.valueOf(GestionReclamos.getInstancia().getCantidadReclamosMes(Integer.parseInt(String.valueOf(comboBoxMes.getSelectedItem())))));
			}
		});
