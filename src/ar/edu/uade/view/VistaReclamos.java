...
public class VistaReclamos extends JFrame implements NuevoReclamoObs{
    ...
    private VistaReclamos(Integer codigoUsuario) {
        ...
        lbAlerta = new JLabel("Ultimo Reclamo creado :" + GestionReclamos.getInstancia().getUltimoReclamo().getDescripcion());
        ...
        btnVerEventos.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
            	...
            	JFrame vistaEventoReclamo = new VistaEventoReclamo(numeroReclamoElegido, GestionReclamos.getInstancia().puedeCrearEventos(codigoUsuario), codigoUsuario);
            	setVisible(false);
